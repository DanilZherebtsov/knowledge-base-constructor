...
- **Где лежит:** публичное зеркало — [github.com/DanilZherebtsov/knowledge-base-constructor](https://github.com/DanilZherebtsov/knowledge-base-constructor). (English edition: [knowledge-base-constructor-en](https://github.com/DanilZherebtsov/knowledge-base-constructor-en).)
