...
- **Запустить:** склонируй [публичное зеркало](https://github.com/DanilZherebtsov/knowledge-base-constructor) в пустой репозиторий и просто начни разговор — конструктор интервью соберёт проект. См. [START-HERE.md](START-HERE.md).
